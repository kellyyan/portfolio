    ...
    return (
        <div className='parent'>
            <div className='left-child'>
                <img src={frogWithSunglasses}></img>
                <h3 className='field-header'>Graphic Design</h3>
                <p>Check out my graphic design portfolio <a className='document-link' href={GraphicDesignPortfolio} target='_blank'>here.</a></p>
            </div>
            <div className='right-child'>
            <img src={frogWithGlasses}></img>
                <h3 className='field-header'>Web Development</h3>
                <p>Check out my web development projects <a className='document-link' href='https://github.com/kellyyan' target='_blank'>here.</a></p>
            </div>
        </div>
